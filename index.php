...
<body>
    <div class="page-wrapper">
        <header>
            <div class="row bg-primary align-items-center">
                ...
                <div class="search-bar col d-flex align-items-center bg-secondary">
                    ...
                    id="search-btn">
                        <img loading="lazy" src="./imgs/icons/search.png" alt="search" width="24" height="24">
                    </button>
                </div>
                    ...
                    <div class="login w-50 d-flex justify-content-center">
                        ...
                        if (isset($_SESSION['ten_dang_nhap'])) {
                            ...
                            '<a href="./member/user_info.php" class="fw-bold text-white">
                                <img loading="lazy" src="./imgs/icons/user.png" alt="user" width="32" height="32">
            ...
            <div class="tabs row justify-content-between align-items-center bg-white p-3 ps-5 gap-3">
                <div class="tab tab-selected col">
                    <a href="./index.php">
                        <img loading="lazy" src="./imgs/icons/house_white.png" alt="home" width="24" height="24">
                        Trang chủ
                    </a>
                </div>
                <div class="tab col">
                    <a href="./public/product_list.php?product_type=1">
                        <img loading="lazy" src="./imgs/icons/phone_iphone.png" alt="phone" width="24" height="24">
                        Điện thoại
                    </a>
                </div>  
                <div class="tab col">
                    <a href="./public/product_list.php?product_type=0">
                        <img loading="lazy" src="./imgs/icons/laptop_mac.png" alt="laptop" width="24" height="24">
                        Laptop
                    </a>
                </div>
                <div class="tab col">
                    <a href="./public/product_list.php?product_type=2">
                        <img loading="lazy" src="./imgs/icons/tablet_android.png" alt="tablet" width="24" height="24">
                        Tablet
                    </a>
                </div>
                <div class="tab col">
                    <a href="./public/product_list.php?product_type=3">
                        <img loading="lazy" src="./imgs/icons/gamepad.png" alt="other" width="24" height="24">
                        Phụ kiện
                        <img loading="lazy" src="./imgs/icons/keyboard_arrow_down.png" alt="arrow-down" width="24" height="24">
                    </a>
                    <div class="dropdown-content">
        ...
        <main class="d-flex flex-column justify-content-center align-items-center">
            <div class="banner container p-3 mb-3">
                <img loading="lazy" src="./imgs/icons/banner.png" alt="banner" style="width: 100%; height: 100%;">
                ...
                <div class="products-line">
                    <div class="title d-flex justify-content-between">
                        ...
                        <a class="m-0" href="./public/product_list.php?product_type=1">
                            Xem tất cả <img loading="lazy" src="./imgs/icons/arrow_right.png" alt="all" width="18" height="18">
                        </a>
                    </div>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                '<a class="product bg-white" href="./public/product_detail.php?product_id='.$row['ma_sp'].'">
                                    <img loading="lazy" class="product-img d-block mx-auto" src="'.$row['hinh_anh'].'" alt="'.$row['ten_sp'].'" width="50" height="50">
            ...
            <div class="row justify-content-evenly infomations">
                <div class="contact col-sm-3 col-7 pt-sm-4">
                    ...
                    <div class="phone-wrapper">
                        <img loading="lazy" src="./imgs/icons/call_icon.png" alt="phone" width="24" height="24">
                        <span>Gọi mua:</span>
                    </div>
    ...
    <script src="./scripts/public/search.js" defer></script>
</body>
</html>